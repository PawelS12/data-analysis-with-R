...
```{r}
# Your answer here:
rand_mat <- matrix(runif(20), nrow = 4, ncol = 5)
print(rand_mat)
```
...
```{r}
# Your answer here:
invert_mat <- matrix(c(1, 2, 3, 4), nrow = 2, byrow = TRUE)
invert_mat_inv <- solve(invert_mat)
identity_mat <- invert_mat %*% invert_mat_inv
identity_mat_rounded <- round(identity_mat, 5)
print(invert_mat)
print(invert_mat_inv)
print(identity_mat_rounded)
...
```{r}
# Your answer here:
det_invert_mat <- det(invert_mat)
print(det_invert_mat)
```
