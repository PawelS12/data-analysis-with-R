...
Sex <- c("M", "M", "F")
person_frame <- data.frame(Name, Age, Weight, Sex)
person_frame
...
```{r}
# Your solution here:
average_mpg <- mean(df$mpg[df$hp > 100 & df$wt > 2.5])
print(average_mpg)
...
```{r}
# Your solution here:
mpg_hornet <- df["Hornet Sportabout", "mpg"]
print(mpg_hornet)
