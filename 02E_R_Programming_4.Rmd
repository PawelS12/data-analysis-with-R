...
checker <- function(target, vector) {
  return(sum(vector == number))
}

vector <- c(1, 2, 3, 4, 2, 5, 2, 6)
number <- 2

counter <- checker(number, vector)
cat(counter)
